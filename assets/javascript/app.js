$(document).ready(function () {
    ...
    function populatePortfolio() {
        ...
        var projcard3 = $("<div class='col s12 m6 l4'><div class='card medium'><div class='card-image'><img src='assets/images/256x256bb.jpg'><span style='font-size:1.40em;' class='card-title white-text red'>Word Guess Game</span></div><div class='card-content'><p class='card-textcontent'>Word guess game.</p></div><a style='font-size:1.40em;padding:10px;' class='red-text' href='https://github.com/jveltrie/Word-Guess-Game' target='_blank'>View Project</a><p style='font-size:1.40em;margin-top: 15px; margin-bottom: 5px;'><a class='black-text' href=' https://jveltrie.github.io/Word-Guess-Game' target='_blank'>GitHub</a></p></div></div>");
