$(document).ready(function () {
    ...
    function populatePortfolio() {
        ...
        var projcard6 = $("<div class='col s12 m6 l4'><div class='card medium'><div class='card-image'><img src='assets/images/hufflepuff.jpeg'><span style='font-size:1.40em;' class='card-title white-text red'>Tagipedia</span></div><div class='card-content'><p class='card-textcontent'>Search for Music and Books</p></div><a style='font-size:1.40em;padding:10px;' class='red-text' href='https://house-hufflepuff.herokuapp.com/' target='_blank'>View Project</a><p style='font-size:1.40em;margin-top: 15px; margin-bottom: 5px;'><a class='black-text' href='https://github.com/TheTrepanier/house-hufflepuff' target='_blank'>GitHub</a></p></div></div>");
